...
After completing each exercise: git add, git commit and git push to your forked repository.
...
This is similar to how you used to solve for x in high school, 😄, remember this?
...
You can go ahead and print the name variable and see what you get 😄
...
Use Python variables to store values of different types (integers, floats, strings, booleans).
Display messages using the print statement based on the variable values.
...
Use the type() function to identify the data types of variables.
...
Practice using various arithmetic operators for addition, subtraction, multiplication, division, and modulus (remainder).
...
You will complete a for loop to print numbers from 0 to 5.
